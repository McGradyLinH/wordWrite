package com.test.pay.web;

import org.springframework.lang.Nullable;

/**
 * @Author chengtianqi
 * @create 2020/6/14 13:55
 */
public enum ErrorStatus {
     ...
     */
    NON_AUTHORITATIVE_INFORMATION(203, "无授权信息"),
    /**
     * {@code 204 No Content}.
     ...
     * @deprecated in favor of {@link #FOUND} which will be returned from {@code ErrorStatus.valueOf(302)}
     */
    @Deprecated
     ...
     * returned from {@code ErrorStatus.valueOf(413)}
     */
    @Deprecated
     ...
     * @deprecated in favor of {@link #URI_TOO_LONG} which will be returned from {@code ErrorStatus.valueOf(414)}
     */
    @Deprecated
    ...
    public static ErrorStatus valueOf(int statusCode) {
        ErrorStatus status = resolve(statusCode);
        if (status == null) {
    ...
    /**
     * Resolve the given status code to an {@code ErrorStatus}, if possible.
     * @param statusCode the HTTP status code (potentially non-standard)
     * @return the corresponding {@code ErrorStatus}, or {@code null} if not found
     * @since 5.0
     */
    @Nullable
    public static ErrorStatus resolve(int statusCode) {
     ...
     * <p>Retrievable via {@link ErrorStatus#series()}.
     */
    public enum Series {
         ...
         */
        public static Series valueOf(ErrorStatus status) {
        ...
        /**
         * Resolve the given status code to an {@code ErrorStatus.Series}, if possible.
         * @param statusCode the HTTP status code (potentially non-standard)
