...
public class TestWebOcr {
	...
	private static final String TEST_APPID = "5b7cd554";
	// 接口密钥(webapi类型应用开通手写文字识别后，控制台--我的应用---手写文字识别---相应服务的apikey)
	private static final String TEST_API_KEY = "2af393b8ff26a3b8cf8bd42a94949965";
	// 测试图片文件存放位置
	private static final String IMAGE_FILE_PATH = "C:\\Users\\lx\\Downloads\\ocr_handwriting_java_demo\\ocr_handwriting_java_demo\\webocr_demo\\resource\\ocr.jpg";
